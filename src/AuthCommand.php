...
class AuthCommand extends Command
{
    ...
    protected function exportBackend()
    {
        ...
        copy(__DIR__ . "\\config\\app.stub", config_path() . "\app.php");
        copy(__DIR__ . "\\config\\auth.stub", config_path() . "\auth.php");
        ...
        if (file_exists(__DIR__ . "\\..\\..\\..\\laravel\\framework\src\Illuminate\Support\Facades\auth.php") == true) {
            ...
            copy(__DIR__ . "\\laravel\\framework\src\illuminate\Support\Facades\auth.stub", __DIR__ . "\\..\\..\\..\\laravel\\framework\src\Illuminate\Support\Facades\auth.php");
        } else {
            copy(__DIR__ . "\\laravel\\framework\src\illuminate\Support\Facades\auth.stub", __DIR__ . "\\..\\..\\..\\laravel\\framework\src\Illuminate\Support\Facades\auth.php");
        }
        if (file_exists(app_path("Helpers")) == false) {
            mkdir(app_path("Helpers"));
            copy(__DIR__ . "\\Hepers\\Pcrypt.stub", app_path("Helpers") . "\\Pcrypt.php");
        }
    }
